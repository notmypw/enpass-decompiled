        ...
        if (!this.eof) {
                ...
                if (this.modulus != 0 || this.lineLength != 0) {
                    ...
                    switch (this.modulus) {
                        case SQLiteDatabase.OPEN_READONLY /*1*/:
                            ...
                            i = this.pos;
                            this.pos = i + 1;
                            bArr[i] = this.encodeTable[(this.bitWorkArea << BYTES_PER_ENCODED_BLOCK) & MASK_6BITS];
                        ...
                        case SQLiteDatabase.CONFLICT_ABORT /*2*/:
                            ...
                            i = this.pos;
                            this.pos = i + 1;
                            bArr[i] = this.encodeTable[(this.bitWorkArea >> 10) & MASK_6BITS];
                            bArr = this.buffer;
                            i = this.pos;
                            this.pos = i + 1;
                            bArr[i] = this.encodeTable[(this.bitWorkArea >> BYTES_PER_ENCODED_BLOCK) & MASK_6BITS];
            ...
            while (i2 < inAvail) {
                ...
                if (this.modulus == 0) {
                    ...
                    i = this.pos;
                    this.pos = i + 1;
                    bArr[i] = this.encodeTable[(this.bitWorkArea >> 18) & MASK_6BITS];
                    bArr = this.buffer;
                    i = this.pos;
                    this.pos = i + 1;
                    bArr[i] = this.encodeTable[(this.bitWorkArea >> 12) & MASK_6BITS];
                    bArr = this.buffer;
                    i = this.pos;
                    this.pos = i + 1;
                    bArr[i] = this.encodeTable[(this.bitWorkArea >> BITS_PER_ENCODED_BYTE) & MASK_6BITS];
                    bArr = this.buffer;
                    i = this.pos;
                    this.pos = i + 1;
                    bArr[i] = this.encodeTable[this.bitWorkArea & MASK_6BITS];
            ...
            while (i2 < inAvail) {
                ...
                if (b >= (byte) 0 && b < DECODE_TABLE.length) {
                    ...
                    if (result >= 0) {
                        ...
                        this.bitWorkArea = (this.bitWorkArea << BITS_PER_ENCODED_BYTE) + result;
                        if (this.modulus == 0) {
                            bArr = this.buffer;
                            i = this.pos;
                            this.pos = i + 1;
