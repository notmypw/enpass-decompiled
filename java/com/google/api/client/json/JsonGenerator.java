        ...
        if (value != null) {
            ...
            if (Data.isNull(value)) {
                ...
                if (isJsonString) {
                    ...
                    r18 = (Float.isInfinite(floatValue) || Float.isNaN(floatValue)) ? false : true;
                    Preconditions.checkArgument(r18);
                    writeNumber(floatValue);
                } else if ((value instanceof Integer) || (value instanceof Short) || (value instanceof Byte)) {
                    writeNumber(((Number) value).intValue());
                } else {
                    double doubleValue = ((Number) value).doubleValue();
                    r18 = (Double.isInfinite(doubleValue) || Double.isNaN(doubleValue)) ? false : true;
                    Preconditions.checkArgument(r18);
