...
public class a {
    ...
    public void a(String str, String str2, String str3, String str4) {
        ...
        try {
            d.a(str2, OAuthActivity.USER_ID);
            d.a(str3, "receiptId");
    ...
    public Set<Receipt> b(String str) {
        ...
        for (String str2 : all.keySet()) {
            ...
            try {
                ...
                a(str2);
                e.b(a, "failed to verify signature:[" + str3 + "]");
            } catch (JSONException e2) {
                a(str2);
                e.b(a, "failed to convert string to JSON object:[" + str3 + "]");
            } catch (Throwable th) {
                e.b(a, "failed to load the receipt from SharedPreference:[" + str3 + "]");
            }
        }
