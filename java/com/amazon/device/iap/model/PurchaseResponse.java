...
public final class PurchaseResponse {
    ...
    public JSONObject toJSON() throws JSONException {
        ...
        jSONObject.put(USER_DATA, this.userData != null ? this.userData.toJSON() : BuildConfig.FLAVOR);
        jSONObject.put(RECEIPT, getReceipt() != null ? getReceipt().toJSON() : BuildConfig.FLAVOR);
        return jSONObject;
    }
}
