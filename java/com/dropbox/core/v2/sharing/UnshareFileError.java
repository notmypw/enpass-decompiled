...
public final class UnshareFileError {
    ...
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$dropbox$core$v2$sharing$UnshareFileError$Tag = new int[Tag.values().length];
    ...
    static class Serializer extends UnionSerializer<UnshareFileError> {
        ...
        public void serialize(UnshareFileError value, JsonGenerator g) throws IOException, JsonGenerationException {
            switch (AnonymousClass1.$SwitchMap$com$dropbox$core$v2$sharing$UnshareFileError$Tag[value.tag().ordinal()]) {
        ...
        public UnshareFileError deserialize(JsonParser p) throws IOException, JsonParseException {
            ...
            if ("user_error".equals(tag)) {
                ...
                value = UnshareFileError.userError(Serializer.INSTANCE.deserialize(p));
            } else if ("access_error".equals(tag)) {
                StoneSerializer.expectField("access_error", p);
                value = UnshareFileError.accessError(Serializer.INSTANCE.deserialize(p));
            } else {
    ...
    public boolean equals(Object obj) {
        ...
        switch (AnonymousClass1.$SwitchMap$com$dropbox$core$v2$sharing$UnshareFileError$Tag[this._tag.ordinal()]) {
            case SQLiteDatabase.OPEN_READONLY /*1*/:
