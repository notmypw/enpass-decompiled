...
public enum MemberPolicy {
    ...
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$dropbox$core$v2$sharing$MemberPolicy = null;

        static {
            $SwitchMap$com$dropbox$core$v2$sharing$MemberPolicy = new int[MemberPolicy.values().length];
            try {
    ...
    static class Serializer extends UnionSerializer<MemberPolicy> {
        ...
        public void serialize(MemberPolicy value, JsonGenerator g) throws IOException, JsonGenerationException {
            switch (AnonymousClass1.$SwitchMap$com$dropbox$core$v2$sharing$MemberPolicy[value.ordinal()]) {
