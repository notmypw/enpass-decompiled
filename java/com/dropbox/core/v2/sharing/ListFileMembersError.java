...
public final class ListFileMembersError {
    ...
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$dropbox$core$v2$sharing$ListFileMembersError$Tag = new int[Tag.values().length];

        static {
            try {
                $SwitchMap$com$dropbox$core$v2$sharing$ListFileMembersError$Tag[Tag.USER_ERROR.ordinal()] = 1;
    ...
    static class Serializer extends UnionSerializer<ListFileMembersError> {
        ...
        public void serialize(ListFileMembersError value, JsonGenerator g) throws IOException, JsonGenerationException {
            switch (AnonymousClass1.$SwitchMap$com$dropbox$core$v2$sharing$ListFileMembersError$Tag[value.tag().ordinal()]) {
        ...
        public ListFileMembersError deserialize(JsonParser p) throws IOException, JsonParseException {
            ...
            if ("user_error".equals(tag)) {
                ...
                value = ListFileMembersError.userError(Serializer.INSTANCE.deserialize(p));
            } else if ("access_error".equals(tag)) {
                StoneSerializer.expectField("access_error", p);
                value = ListFileMembersError.accessError(Serializer.INSTANCE.deserialize(p));
            } else {
    ...
    public boolean equals(Object obj) {
        ...
        switch (AnonymousClass1.$SwitchMap$com$dropbox$core$v2$sharing$ListFileMembersError$Tag[this._tag.ordinal()]) {
            case SQLiteDatabase.OPEN_READONLY /*1*/:
