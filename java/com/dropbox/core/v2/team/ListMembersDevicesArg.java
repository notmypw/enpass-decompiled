    ...
    static class Serializer extends StructSerializer<ListMembersDevicesArg> {
        ...
        public ListMembersDevicesArg deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ...
            if (tag == null) {
                ...
                ListMembersDevicesArg value = new ListMembersDevicesArg(f_cursor, f_includeWebSessions.booleanValue(), f_includeDesktopClients.booleanValue(), f_includeMobileClients.booleanValue());
                if (!collapsed) {
