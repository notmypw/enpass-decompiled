...
public final class TeamFolderArchiveError {
    ...
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$dropbox$core$v2$team$TeamFolderArchiveError$Tag = new int[Tag.values().length];

        static {
            try {
                $SwitchMap$com$dropbox$core$v2$team$TeamFolderArchiveError$Tag[Tag.ACCESS_ERROR.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$com$dropbox$core$v2$team$TeamFolderArchiveError$Tag[Tag.STATUS_ERROR.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                $SwitchMap$com$dropbox$core$v2$team$TeamFolderArchiveError$Tag[Tag.OTHER.ordinal()] = 3;
    ...
    static class Serializer extends UnionSerializer<TeamFolderArchiveError> {
        ...
        public void serialize(TeamFolderArchiveError value, JsonGenerator g) throws IOException, JsonGenerationException {
            switch (AnonymousClass1.$SwitchMap$com$dropbox$core$v2$team$TeamFolderArchiveError$Tag[value.tag().ordinal()]) {
        ...
        public TeamFolderArchiveError deserialize(JsonParser p) throws IOException, JsonParseException {
            ...
            if ("access_error".equals(tag)) {
                ...
                value = TeamFolderArchiveError.accessError(Serializer.INSTANCE.deserialize(p));
            } else if ("status_error".equals(tag)) {
                StoneSerializer.expectField("status_error", p);
                value = TeamFolderArchiveError.statusError(Serializer.INSTANCE.deserialize(p));
    ...
    private TeamFolderArchiveError(Tag _tag, TeamFolderAccessError accessErrorValue, TeamFolderInvalidStatusError statusErrorValue) {
        this._tag = _tag;
    ...
    public static TeamFolderArchiveError accessError(TeamFolderAccessError value) {
        if (value != null) {
            return new TeamFolderArchiveError(Tag.ACCESS_ERROR, value, null);
        }
    ...
    public static TeamFolderArchiveError statusError(TeamFolderInvalidStatusError value) {
        if (value != null) {
            return new TeamFolderArchiveError(Tag.STATUS_ERROR, null, value);
        }
        throw new IllegalArgumentException("Value is null");
    }
    ...
    public boolean equals(Object obj) {
        ...
        switch (AnonymousClass1.$SwitchMap$com$dropbox$core$v2$team$TeamFolderArchiveError$Tag[this._tag.ordinal()]) {
            case SQLiteDatabase.OPEN_READONLY /*1*/:
