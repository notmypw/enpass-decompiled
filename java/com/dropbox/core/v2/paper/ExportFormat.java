...
public enum ExportFormat {
    ...
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$dropbox$core$v2$paper$ExportFormat = null;

        static {
            $SwitchMap$com$dropbox$core$v2$paper$ExportFormat = new int[ExportFormat.values().length];
            try {
                $SwitchMap$com$dropbox$core$v2$paper$ExportFormat[ExportFormat.HTML.ordinal()] = 1;
    ...
    static class Serializer extends UnionSerializer<ExportFormat> {
        ...
        public void serialize(ExportFormat value, JsonGenerator g) throws IOException, JsonGenerationException {
            switch (AnonymousClass1.$SwitchMap$com$dropbox$core$v2$paper$ExportFormat[value.ordinal()]) {
