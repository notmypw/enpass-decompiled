...
public final class GetTemporaryLinkError {
    ...
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$dropbox$core$v2$files$GetTemporaryLinkError$Tag = new int[Tag.values().length];

        static {
            try {
                $SwitchMap$com$dropbox$core$v2$files$GetTemporaryLinkError$Tag[Tag.PATH.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$com$dropbox$core$v2$files$GetTemporaryLinkError$Tag[Tag.OTHER.ordinal()] = 2;
    ...
    static class Serializer extends UnionSerializer<GetTemporaryLinkError> {
        ...
        public void serialize(GetTemporaryLinkError value, JsonGenerator g) throws IOException, JsonGenerationException {
            switch (AnonymousClass1.$SwitchMap$com$dropbox$core$v2$files$GetTemporaryLinkError$Tag[value.tag().ordinal()]) {
        ...
        public GetTemporaryLinkError deserialize(JsonParser p) throws IOException, JsonParseException {
            ...
            if (BoxMetadataUpdateTask.PATH.equals(tag)) {
                ...
                value = GetTemporaryLinkError.path(com.dropbox.core.v2.files.LookupError.Serializer.INSTANCE.deserialize(p));
            } else {
    ...
    public boolean equals(Object obj) {
        ...
        switch (AnonymousClass1.$SwitchMap$com$dropbox$core$v2$files$GetTemporaryLinkError$Tag[this._tag.ordinal()]) {
            case SQLiteDatabase.OPEN_READONLY /*1*/:
