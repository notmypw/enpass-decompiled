...
public final class SearchError {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                $SwitchMap$com$dropbox$core$v2$files$SearchError$Tag[Tag.OTHER.ordinal()] = 2;
    ...
    static class Serializer extends UnionSerializer<SearchError> {
        ...
        public void serialize(SearchError value, JsonGenerator g) throws IOException, JsonGenerationException {
            switch (AnonymousClass1.$SwitchMap$com$dropbox$core$v2$files$SearchError$Tag[value.tag().ordinal()]) {
        ...
        public SearchError deserialize(JsonParser p) throws IOException, JsonParseException {
            ...
            if (BoxMetadataUpdateTask.PATH.equals(tag)) {
                ...
                value = SearchError.path(com.dropbox.core.v2.files.LookupError.Serializer.INSTANCE.deserialize(p));
            } else {
    ...
    public boolean equals(Object obj) {
        ...
        switch (AnonymousClass1.$SwitchMap$com$dropbox$core$v2$files$SearchError$Tag[this._tag.ordinal()]) {
            case SQLiteDatabase.OPEN_READONLY /*1*/:
