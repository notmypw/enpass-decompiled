...
public class BoxApiCollection extends BoxApi {
    ...
    protected String getCollectionItemsUrl(String id) {
        return String.format("%s/%s/items", new Object[]{getCollectionsUrl(), id});
    }
    ...
    public GetCollectionItems getItemsRequest(String id) {
        return new GetCollectionItems(getCollectionItemsUrl(id), this.mSession);
    }
}
